...
#+deprecated(def-neo4j-fun query (statement)
  :post
  (:uri-spec "cypher")
...
#+deprecated(def-neo4j-fun get-node (node-id)
  :get
  (:uri-spec (if node-id
...
#+deprecated(def-neo4j-fun create-node (properties)
  :post
...
#+deprecated(def-neo4j-fun set-node-label (node-id label)
  :post
...
#+deprecated(def-neo4j-fun delete-node (node-id)
  :delete
...
#+deprecated(def-neo4j-fun set-node-properties (node-id properties)
  :put
  (:encode properties :string)
...
#+deprecated(def-neo4j-fun get-node-properties (node-id)
  :get
  (:uri-spec (format nil "node/~A/properties" node-id))
  (:status-handlers
   (200 (decode-neo4j-json-output body))
...
#+deprecated(def-neo4j-fun del-node-properties (node-id)
  :delete
  (:uri-spec (format nil "node/~A/properties" node-id))
  (:status-handlers
   (204 (values t body))
...
#+deprecated(def-neo4j-fun set-node-property (node-id property value)
  :put
...
#+deprecated(def-neo4j-fun get-node-property (node-id property)
  :get
  (:uri-spec (format nil "node/~A/properties/~A" node-id
                     (if (symbolp property)
                         (string-downcase (symbol-name property))
...
#+deprecated(def-neo4j-fun del-node-property (node-id property)
  :delete
  (:uri-spec (format nil "node/~A/properties/~A" node-id
                     (if (symbolp property)
                         (string-downcase (symbol-name property))
...
#+deprecated(def-neo4j-fun get-relationship (relationship-id)
  :get
...
#+deprecated(def-neo4j-fun create-relationship (node-id to-node-id relationship-type properties)
  :post
...
#+deprecated(def-neo4j-fun delete-relationship (relationship-id)
  :delete
  (:uri-spec (format nil "relationship/~A" relationship-id))
  (:status-handlers
   (204 (values t body))
...
#+deprecated(def-neo4j-fun set-relationship-properties (relationship-id properties)
  :put
...
#+deprecated(def-neo4j-fun get-relationship-properties (relationship-id)
  :get
  (:uri-spec (format nil "relationship/~A/properties" relationship-id))
  (:status-handlers
   (200 (decode-neo4j-json-output body))
...
#+deprecated(def-neo4j-fun del-relationship-properties (relationship-id)
  :delete
  (:uri-spec (format nil "relationship/~A/properties" relationship-id))
  (:status-handlers
   (204 (values t body))
...
#+deprecated(def-neo4j-fun set-relationship-property (relationship-id property value)
  :put
...
#+deprecated(def-neo4j-fun get-relationship-property (relationship-id property)
  :get
  (:uri-spec (format nil "relationship/~A/properties/~A"
                     relationship-id
                     (if (symbolp property)
...
#+deprecated(def-neo4j-fun del-relationship-property (relationship-id property)
  :delete
  (:uri-spec (format nil "relationship/~A/properties/~A"
                     relationship-id
                     (if (symbolp property)
...
#+deprecated(def-neo4j-fun get-node-relationships (node-id direction types)
  :get
...
#+deprecated(def-neo4j-fun get-relationships-types ()
  :get
...
#+deprecated(def-neo4j-fun create-index ((type :node) name config)
               :post
...
#+deprecated(def-neo4j-fun delete-index ((type :node) name)
  :delete
...
#+deprecated(def-neo4j-fun list-indexes ((type :node))
  :get
  (:uri-spec (format nil "index/~A" (string-downcase (symbol-name type))))
  (:status-handlers
   (200 (decode-neo4j-json-output body))
...
#+deprecated(def-neo4j-fun add-to-index ((type :node) name key value object-id)
  :post
...
#+deprecated(def-neo4j-fun remove-from-index ((type :node) name key value object-id)
  :delete
...
#+deprecated(def-neo4j-fun lookup-index ((type :node) name key value)
  :get
...
#+deprecated(def-neo4j-fun query-index ((type :node) name query)
  :get
...
#+deprecated(def-neo4j-fun query-label (label-name key value)
  :get
...
#+deprecated(def-neo4j-fun traverse (node-id (return-type :node) (max-depth 1) (order :depth-first)
...
#+deprecated(def-neo4j-fun get-path (node-id to-node-id relationships (max-depth 3) (algorithm :shortest-path))
  :post
...
#+deprecated(def-neo4j-fun get-paths (node-id to-node-id relationships (max-depth 3) (algorithm :shortest-path))
  :post
